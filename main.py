...
token=input("\x1b[38;5;213m> \033[37mToken\x1b[38;5;213m: \033[37m" )
...
[X] EXIT                       
    ...
    if choice == "1":
        guildIint(input("\x1b[38;5;213m> \033[37mGuild ID\x1b[38;5;213m: \033[37m"))
        try:
...
try:
    ...
    RPC.update(details="Main Menu", large_image="seraph", small_image="seraph", large_text="DynoxyPlayZ", start=time.time())
except:
    pass
